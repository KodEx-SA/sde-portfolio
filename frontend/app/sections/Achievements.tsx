...
const certificates = [
  ...
  },
  {
    ...
    color: "from-brand-500/20 to-iris-500/10",
  },
  {
    title: "IT Essentials",
    issuer: "Cisco Networking Academy",
    ...
    color: "from-teal-500/20 to-brand-500/10",
  },
  {
    ...
    color: "from-iris-500/20 to-teal-500/10",
  },
]
  ...
  return (
    <section id="achievements" className="relative py-24 md:py-32 px-6 md:px-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col gap-3 mb-14">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white font-mono">
            Certifications &amp; <span className="text-brand-400">Awards</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {certificates.map((cert, i) => (
            <button
              ...
              className="group text-left rounded-xl border border-brand-500/10 bg-[#080808] hover:border-brand-500/30 transition-all duration-300 overflow-hidden focus:outline-none focus:ring-2 focus:ring-brand-500/30 hover:-translate-y-1"
            >
              {/* ======================== Image ======================== */}
              <div className="relative h-44 w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="w-10 h-10 rounded-full bg-black/60 backdrop-blur-sm border border-brand-500/30 flex items-center justify-center">
                ...
                <div className="absolute top-2.5 right-2.5">
                  <div className="w-7 h-7 rounded-full bg-black/60 backdrop-blur-sm border border-brand-500/30 flex items-center justify-center">
              ...
              {/* ======================== Content ======================== */}
              <div className="p-4">
                <p className="text-brand-700 font-mono text-[9px] mb-1.5">{cert.year} · {cert.issuer}</p>
                <h3 className="text-white font-mono font-bold text-xs group-hover:text-brand-400 transition-colors duration-200 leading-snug mb-2">
                  {cert.title}
                </h3>
                <p className="text-gray-700 font-mono text-[10px] leading-relaxed line-clamp-2">
                  {cert.description}
                </p>
                <p className="text-brand-800 font-mono text-[9px] mt-3 group-hover:text-brand-600 transition-colors">
                  click to enlarge
                </p>
              </div>
            </button>
      ...
      {selected && (
        ...
        >
          <div
            className="relative max-w-xl w-full bg-[#080808] rounded-2xl border border-brand-500/20 overflow-hidden shadow-[0_0_80px_rgba(125,207,255,0.12)]"
          ...
          >
            ...
            {/* ======================== Info ======================== */}
            <div className="p-5 border-t border-brand-500/10">
              <p className="text-brand-600 font-mono text-[10px] mb-1.5">{selected.issuer} · {selected.year}</p>

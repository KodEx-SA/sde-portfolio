  ...
  return (
    <>
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[linear-gradient(rgba(122,162,247,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(122,162,247,0.025)_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none"
        />

      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col gap-3 mb-14">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white font-mono">
            Who Am <span className="text-brand-400">I?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-16 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="relative w-fit">
              <div className="absolute -inset-1.5 rounded-2xl bg-gradient-to-br from-brand-500/20 to-transparent blur" />
              <div className="relative w-48 h-48 md:w-56 md:h-56 rounded-2xl overflow-hidden border border-brand-500/20">
                <Image
              ...
              <div className="absolute -top-2 -left-2 w-4 h-4 border-t-2 border-l-2 border-brand-500/50" />
              <div className="absolute -bottom-2 -right-2 w-4 h-4 border-b-2 border-r-2 border-brand-500/50" />
            </div>
            ...
            <div className="flex flex-col gap-3">
              {facts.map(({ icon: Icon, label, value }) => (
                <div key={label} className="flex items-start gap-3 group">
                  <div className="mt-0.5 w-7 h-7 rounded-md bg-brand-500/8 border border-brand-500/15 flex items-center justify-center flex-shrink-0 group-hover:border-brand-500/35 transition-colors duration-200">
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* ======================== Active roles ======================== */}
            <div>
              <p className="text-brand-600 font-mono text-[10px] mb-4">$ cat active_roles.txt</p>
              <div className="flex flex-col gap-2.5">
                {roles.map((role, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 p-3.5 rounded-xl border border-brand-500/10 bg-brand-500/3 hover:border-brand-500/25 hover:bg-brand-500/6 transition-all duration-200 group"
                  >
                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-brand-400 flex-shrink-0 animate-pulse" />
                    <div>
                      ...
                      <p className="text-gray-600 font-mono text-[10px] mt-0.5">
                        {role.company}
                        <span className="text-brand-800 ml-1.5">— {role.type}</span>
                      </p>
                    </div>
                  </div>
                ))}
